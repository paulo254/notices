...
<form class="form-labels-on-top" action= "administration_upload.php" method= "POST" enctype="multipart/form-data">
...
$mysql_query = "INSERT INTO administration (name, email, category, description, edate, picture_name) VALUES ('$n_name', '$email', '$category', '$description', '$edate', '$image_name')";
