...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO admins(username,email,password) VALUES('$uname','$email','$upass')"))
 {
  ?>
        ...
        <?php
        header("Location: su_view_admins.php");
 }
 else
 {
  ?>
        <script>alert('error while registering admin...');</script>
        <?php
 }
}
?>
		...
		<div class="top-header-main">
			...
			<div class="col-md-4 top-header-right">
				<div class="cart box_1">						
						<p>Adding admin</class="simpleCart_empty">
...
<tr>
<td><button type="submit" name="btn-signup">add admin</button></td>
</tr>
<!--
<tr>
